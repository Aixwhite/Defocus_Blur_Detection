...
class BagDataset(Dataset):
    ...
    def __init__(self, transform=None,file_name=None):
        ...
        self.file_name_1=file_name.replace('source','gt')
    def __len__(self):
        #file_name = 'D:/learning/moshi/Defocus-blur-detection-main/dataset/test_data/DUT/dut500-gt'
        return len(os.listdir(self.file_name))
        #return len(os.listdir(D:/learning/moshi/Defocus-blur-detection-main/dataset/test_data/DUT/dut500-gt))
    def __getitem__(self, idx):
        ...
        #imgA = cv2.imread('D:\\learning\\moshi\\Defocus-blur-detection-main\\dataset\\test_data\\DUT\\dut500-source\\1.bmp')
