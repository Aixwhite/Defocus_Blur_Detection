...
def train(epochs=1):
    ...
    for i in range(epochs):
        ...
        if np.mod(i, 5) == 0:
            torch.save(model.state_dict(), 'D:\\learning\\moshi\Defocus-blur-detection-main\\code\\Baselines\\Unet\\model\\{}.pth'.format(i))
            mae1, fmeasure1, recall1, precesion1 = test.eval1("D:\\learning\\moshi\\Defocus-blur-detection-main\\code\\Baselines\\BR2Net\\model\\result", "D:\\learning\\moshi\\Defocus-blur-detection-main\\dataset\\test_data\\DUT\\dut500-gt", 0.6)
...
if __name__ == '__main__':
    ...
    try:
        os.makedirs(read_pred,exist_ok=True)
        #os.mkdir(read_pred,exist_ok=True)
    except OSError:
